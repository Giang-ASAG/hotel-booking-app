...
import 'package:application_book/screens/main/Main_Screen.dart';
import 'package:application_book/screens/payment/VnPayWebView_Screen.dart';
import 'package:application_book/widgets/customButton.dart';
  ...
  void btnPayment(BuildContext context) {
    ...
    if (_selectedMethod == 0) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text("VNPay")));
    } else {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text("Zalo")));
    }
  }
        ...
        showPopup(
          ...
          onOkPressed: () async {
            ...
            if (widget.booking != null) {
              ...
              try {
                var result = await _service.bookingService.updateStatus(
