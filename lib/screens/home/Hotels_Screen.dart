...
import 'package:application_book/screens/detail/HotelDetail_Screen.dart';
...
class _HotelScreenState extends State<HotelScreen> {
  ...
  Future<void> fetchHotels() async {
    if (widget.checkinDate != null) {
      try {
        final result = await _service.hotelsService.searchHotel(
          widget.address,
          widget.checkinDate,
          widget.checkoutDate,
          widget.peoplecount!,
      ...
      try {
        final result = await _service.hotelsService.getHotelsbyAddress(
          widget.address,
        );
        setState(() {
